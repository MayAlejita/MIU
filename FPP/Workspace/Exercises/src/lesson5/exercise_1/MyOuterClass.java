...
public class MyOuterClass {
	...
	class MyInnerClass {
		...
		void innerMethod() {
			...
			System.out.println(MyOuterClass.this.param); // same as the following
	...
	public static void main(String[] args) {
		...
		MyOuterClass b = new MyOuterClass(null);
		MyOuterClass.MyInnerClass c = b.new MyInnerClass(null);
		MyOuterClass.MyInnerClass a = new MyOuterClass(null).new MyInnerClass(null);

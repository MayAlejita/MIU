...
public class Rational {
	...
	public Rational(int num, int denom) throws NonPositiveDenomException {
		if(denom <= 0) {
			LOG.warning("Rational: Client attempted to enter a " +
	...
	//a/b + c/d = (ad + bc) / bd
	public Rational add(Rational rat) throws NonPositiveDenomException {
		int a = this.num;
		int b = this.denom;
		int c = rat.num;
		int d = rat.denom;
	...
	//a/b * c/d = ac / bd
	public Rational multiply(Rational rat)  throws NonPositiveDenomException {
		int a = this.num;
		int b = this.denom;
		int c = rat.num;
		int d = rat.denom;

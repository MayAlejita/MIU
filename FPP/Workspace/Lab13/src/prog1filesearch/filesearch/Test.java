...
public class Test extends TestCase {
	...
	private String setupDirectory = System.getProperty("user.dir") + "//src//";
	private String targetFile = "seek.txt";

	@Override
	public void setUp() {
		File f = new File("//prog1filesearch");
		System.out.println(f.mkdirs());
		f = new File("//prog1filesearch//filesearch");
		System.out.println(f.mkdirs());
		f = new File("//prog1filesearch//filesearch1//thirdLevelc");
		System.out.println(f.mkdirs());
		f = new File("C://prog1filesearch//filesearch1//thirdLevelc//fourthLevel");
		System.out.println(f.mkdirs());
